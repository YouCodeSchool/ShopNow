    ...
    <!-- Left bar -->
        ...
        <div class="left-bar-container bg-color center">
            ...
            <div class="flex flex-col center">
                <div class="flex flex-row" onclick="Add_function()" >
                ...
                <form class="flex flex-col">
                    <ul class="flex flex-row" style="justify-content: space-evenly;">
                        <li>
                            ...
                            <input type="text" class="color" id="NFT_Name" name="NFT" placeholder="NFT Name"> 
                        </li>
                        <li>
                        ...
                        <li>
                            <label for="cat_add">Category:</label>
                             <select class="color" id="cat_add" name="product_cat">
